...
Формат работы: читай вопрос, закрой файл, отвечай вслух 2–3 минуты. Потом сверяй с подсказкой.  
Если не можешь ответить — это сигнал: вернись к теории, напиши пример, потом снова попробуй.
...
Для самопроверки — ответь одной фразой:
