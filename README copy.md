# Python Core — структура повторения

Легенда: [понять] — теория/определения; [задачи] — стоит решать задачи; [глубина] — копаемся во внутренностях/памяти.
...
Блоки с [задачи] — практические упражнения руками (без ИИ-помощи); [глубина] — разбирать внутренности CPython, память, GIL.

---

## План подготовки (отдельно от структуры)

> Правило: учебные сессии — без ИИ. 60–90 минут в день, только Python REPL + editor + docs.
